    ...
    <form action={formAction} className="space-y-4">
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="h-12 w-full rounded-xl border border-border bg-surface-2/60 px-4 text-fg outline-none transition-premium focus:border-accent/60 focus:ring-4 focus:ring-accent/10"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            required
            placeholder="••••••••"
            className="h-12 w-full rounded-xl border border-border bg-surface-2/60 px-4 pr-12 text-fg outline-none transition-premium focus:border-accent/60 focus:ring-4 focus:ring-accent/10"
          />
          <button
            type="button"
            onClick={() => setShow((s) => !s)}
